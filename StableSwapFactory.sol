...
contract StableSwapFactory is IStableSwapFactory {
    ...
    function isTimelock(address b) external view override returns (bool) {
        return _timelocks[b];
    }
    ...
    function createPool(
        ...
        address swap = createPoolInternal(_pooledTokens, decimals, lpTokenName, lpTokenSymbol, _a, _fee, _adminFee, _withdrawFee, address(timelock));
    ...
    function createPoolInternal(
        ...
        address swap = ISwapCreator(swapCreator).create(_pooledTokens, decimals, lpTokenName, lpTokenSymbol, _a, _fee, _adminFee, _withdrawFee, timeLock);
